...
/*
 * Macros for device 'FPGA_Bridge', class 'altera_avalon_pio'
 * The macros are prefixed with 'FPGA_BRIDGE_'.
 * The prefix is the slave descriptor.
 */
#define FPGA_BRIDGE_COMPONENT_TYPE altera_avalon_pio
#define FPGA_BRIDGE_COMPONENT_NAME FPGA_Bridge
#define FPGA_BRIDGE_BASE 0x0
#define FPGA_BRIDGE_SPAN 16
#define FPGA_BRIDGE_END 0xf
#define FPGA_BRIDGE_BIT_CLEARING_EDGE_REGISTER 0
#define FPGA_BRIDGE_BIT_MODIFYING_OUTPUT_REGISTER 0
#define FPGA_BRIDGE_CAPTURE 0
#define FPGA_BRIDGE_DATA_WIDTH 24
#define FPGA_BRIDGE_DO_TEST_BENCH_WIRING 0
#define FPGA_BRIDGE_DRIVEN_SIM_VALUE 0
#define FPGA_BRIDGE_EDGE_TYPE NONE
#define FPGA_BRIDGE_FREQ 100000000
#define FPGA_BRIDGE_HAS_IN 0
#define FPGA_BRIDGE_HAS_OUT 1
#define FPGA_BRIDGE_HAS_TRI 0
#define FPGA_BRIDGE_IRQ_TYPE NONE
#define FPGA_BRIDGE_RESET_VALUE 0
...
#define SYSID_ID 0
#define SYSID_TIMESTAMP 1524090208
